...
export default defineConfig({
  output: 'static',
  // TODO: replace once the .co.uk domain is confirmed (must match site.config.js domain).
  site: 'https://TODO_GB_DOMAIN',
  ...
  // Single-locale (British English) — separate Astro build per market.
  i18n: {
    defaultLocale: 'en',
    locales: ['en'],
